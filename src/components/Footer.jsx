...
const deps = [
  ...
  },
  {
    ...
    desc: "Desenvolvedor e mantenedor do projeto",
  },
];

export default function Footer() {
  return (
    <footer className="border-t border-[#2a2a38] py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-lg">clipr</span>
            </div>
            <p className="text-sm text-slate-500 leading-relaxed">
              Ferramenta CLI profissional para download de vídeos do YouTube e
              Instagram Reels.
            </p>
        ...
        <div className="pt-8 border-t border-[#2a2a38] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">
            ...
            <Heart className="inline w-3 h-3 text-red-500 mx-0.5" /> e Python
            por{" "}
            <a
